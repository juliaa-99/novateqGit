...
var gulp = require('gulp'),
    ...
    gulp.task('v360:build', async function() {
        gulp.src(path.src.v360)
            .pipe(gulp.dest(path.build.v360));
            // .pipe(gulp.dest(path.wp.v360));
    });
    ...
    gulp.task('watch', async function(){
        ...
        gulp.watch([path.watch.v360], gulp.series('v360:build'));
    });
