...
// Pano2VR 6.1.6/17950
// Filename: house 77m.ggsk
// Generated 2023-11-08T14:38:43
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._map_1.ggRadar.update=function() {
			...
			if ((me._map_1.ggSimpleFloorplanMarkerArray.hasOwnProperty(currentId)) && filterpassed) {
				...
				radarPath.setAttributeNS(null,'fill', '#c1db46');
				radarPath.setAttributeNS(null,'fill-opacity', 0.35);
				radarPath.setAttributeNS(null,'stroke', '#c1db46');
		...
		me._map_1.ggShowSimpleFloorplan=function(mapDetails) {
			...
			var imageFilename = basePath + 'assets/360/triomod-94v3/images/maptiles/' + me._map_1.ggMapId + '_' + level + '.' + mapDetails['tileformat'];
		...
		me._map_1.ggInitMapMarkers=function() {
			...
			for(var i=0; i < ids.length; i++) {
				...
				if (coords.length>=2) {
					...
					var markerClass = new SkinElement_svg_1_Class(me, markerParent);
					me._map_1.ggMarkerInstances.push(markerClass);
					var marker = markerClass._svg_1;
	...
	function SkinElement_svg_1_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		...
		hs='data:image/svg+xml;base64,'+
			'AgNTAiPgogPHN0eWxlIHR5cGU9InRleHQvY3NzIj4mI3hkOwoJLnN0MHtvcGFjaXR5OjAuOTtmaWxsOiM5NUMxMUY7c3Ryb2tlOiM3NDk3MTk7c3Ryb2tlLW1pdGVybGltaXQ6MTA7fSYjeGQ7Cjwvc3R5bGU+CiA8Y2lyY2xlIGN5PSIyNSIgY3g9IjI1IiByPSIxMi41IiBjbGFzcz0ic3QwIi8+Cjwvc3ZnPgo=';
